                ...
                <td>
                  ...
                  <template v-if="categoria.condicion">
                    <button
                      ...
                      @click="desactivarCategoria(categoria.id, categoria.nombre)"
                    >
                  ...
                  <template v-else>
                    <button
                      ...
                      @click="activarCategoria(categoria.id, categoria.nombre)"
                    >
...
export default {
  ...
  methods: {
    ...
    desactivarCategoria(id, nombre) {
      swal({
        title: "Esta seguro de desactivar esta categoríagggg?",
        type: "warning",
        ...
        if (result.value) {
          ...
          axios
            ...
            .then(function(response) {
              ...
              swal(
                "Desactivado!",
                "El registro ha sido desactivado con éxito." + nombre,
                "success"
              );
            })
            .catch(function(error) {
    ...
    activarCategoria(id, nombre) {
      swal({
        title: "Esta seguro de activar esta categoría?ddd",
        type: "warning",
        showCancelButton: true,
        confirmButtonColor: "#3085d6",
        cancelButtonColor: "#d33",
